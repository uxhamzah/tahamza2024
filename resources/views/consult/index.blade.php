...
<x-without-sidenav>
  <x-slot name="header">
    <h2 class="font-bold text-2xl text-black leading-tight tracking-wider">
        ...
        <div class="lg:w-8/12 text-center mx-auto space-y-12">
          <div class="space-y-8">
            <p class="md:w-3/4 mx-auto">
              Dalam dua minggu terakhir, seberapa sering
            </p>
            ...
            <div class="space-y-6">
              ...
              <div class="space-x-4">
                <div class="inline-flex items-center">
                  <input id="no" name="jawaban" type="radio" value="0" class="focus:ring-indigo-500 h-4 w-4 text-green-600 border-gray-700" required>
                  <label for="no" class="ml-2 block text-sm font-medium text-gray-700">
                    {{ __('No') }}
                  </label>
                </div>
                <div class="inline-flex items-center">
                  <input id="yes" name="jawaban" type="radio" value="1" class="focus:ring-indigo-500 h-4 w-4 text-green-600 border-gray-700" required>
