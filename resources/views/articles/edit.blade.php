    ...
    <div id="formContainer" class="hidden bg-white shadow-md rounded-lg p-4">
      <form method="POST" action="{{ route('articles.update', ['article' => $article->id]) }}" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="block">
          ...
          <input id="title" name="title" autocomplete="title" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 @error('title') border-red-400 @enderror shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" autofocus value="{{ $article->title }}">
          @error('title')
        ...
        <div class="block">
          ...
          <textarea id="body" name="body" class="ckeditor form-textarea mt-2 block w-full rounded-md border-gray-400 @error('body') border-red-400 @enderror shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
            {{ $article->body }}
          </textarea>
          @error('body')
        ...
        <div class="block">
          ...
          <select id="status" name="status" autocomplete="status" class="form-select mt-2 block w-6/12 rounded-md border-gray-400 @error('status') border-red-400 @enderror shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75 capitalize" required>
        ...
        <div class="block">
          ...
          <input id="keywords" name="keywords" autocomplete="keywords" type="text" class="form-input mt-2 block w-6/12 rounded-md border-gray-400 @error('keywords') border-red-400 @enderror shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" value="{{ implode(",", $article->keywords) }}">
        ...
        <div class="block">
          ...
          <select id="writer" name="writer" autocomplete="writer" class="form-select mt-2 block w-6/12 rounded-md border-gray-400 @error('writer') border-red-400 @enderror shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" required>
