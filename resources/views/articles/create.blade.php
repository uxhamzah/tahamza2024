    ...
    <div id="formContainer" class="hidden bg-white shadow-md rounded-lg p-4">
      <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="block">
          ...
          <input id="title" name="title" autocomplete="title" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 @error('title') border-red-400 @enderror shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" autofocus value="{{old('title')}}">
          @error('title')
        ...
        <div class="block">
          ...
          <input id="keywords" name="keywords" autocomplete="keywords" type="text" class="form-input mt-2 block w-6/12 rounded-md border-gray-400 @error('keywords') border-red-400 @enderror shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" value="{{old('keywords')}}">
