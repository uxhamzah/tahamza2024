                      ...
                      <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                          ...
                          <?php
                            if(isset($xx) > 0){
                              ?>
                              <select name="nilai[]" class="form-select mt-2 block w-6/12 rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75 capitalize" style="width: 300px" required="required">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                          <?php
                            if(isset($xx) > 0){
                              ?>
                              <select class="form-select mt-2 block rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75 capitalize" name="keterangan[]">
