        ...
        <x-slot name="content">
            <form wire:submit.prevent="saveNewSymptom" class="flex flex-col space-y-4">
                <div class="block w-6/12">
                   ...
                   <select id="code" wire:model.defer="code" class="form-select mt-2 block w-full rounded-md bg-gray-200 text-gray-800 border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" disabled>
                ...
                <div class="block">
                    ...
                    <textarea id="name" wire:model.defer="name" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" rows="3"></textarea>
                    @error('name')
        ...
        <x-slot name="content">
            <form wire:submit.prevent="saveEditSymptom({{ $symptom_id }})" class="flex flex-col space-y-4">
                <div class="block w-6/12">
                   ...
                   @endphp
                   <select id="codeEdit" wire:model.defer="code" class="form-select mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                ...
                <div class="block">
                    ...
                    <textarea id="nameEdit" wire:model.defer="name" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" rows="3"></textarea>
                    @error('name')
                        <x-jet-input-error for="name" class="mt-2" />
                    @enderror
                </div>
