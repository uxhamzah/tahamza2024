            ...
            <x-slot name="content">
                <form wire:submit.prevent="saveNewExpert" class="flex flex-col w-6/12 space-y-4">
                    ...
                    <div class="block">
                        ...
                        <input id="email" wire:model.defer="email" type="email" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" autofocus>
                        @error('email')
                    ...
                    <div class="block">
                        ...
                        <input id="name" wire:model.defer="name" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                        @error('name')
                    ...
                    <div class="block">
                        ...
                        <input id="password" wire:model.defer="password" type="password" autocomplete="new-password" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                    ...
                    <div class="block">
                        ...
                        <input id="password_confirmation" wire:model.defer="password_confirmation" type="password" autocomplete="new-password" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                        <small class="leading-3 text-gray-700">
                            <span class="text-red-500">*</span>
                            {{ __('Password must be at least 8 characters long and contain lowercase, uppercase, and numbers') }}
                        </small>
                    ...
                    <div class="block">
                        ...
                        <input id="position" wire:model.defer="position" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                        @error('position')
                    ...
                    <div class="block">
                        ...
                        <input id="company" wire:model.defer="company" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                        @error('company')
            ...
            <x-slot name="content">
                <form wire:submit.prevent="saveEditExpert({{ $expert_id }})" class="flex flex-col w-6/12 space-y-4">
                    ...
                    <div class="block">
                        ...
                        <input id="emailEdit" wire:model.defer="email" type="email" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75" autofocus>
                        @error('email')
                            <x-jet-input-error for="email" class="mt-2" />
                        @enderror
                    </div>
                    ...
                    <div class="block">
                        ...
                        <input id="nameEdit" wire:model.defer="name" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                        @error('name')
                            <x-jet-input-error for="name" class="mt-2" />
                        @enderror
                    </div>
                            ...
                            @foreach ($verified_item as $item)
                                <div class="flex items-center">
                                    <input
                                        ...
                                        type="radio"
                                        value="{{ $item == true ? 1 : 0 }}"
                                        class="form-radio focus:ring-green-500 h-4 w-4 text-green-600 border-gray-300"
                    ...
                    <div class="block">
                        ...
                        <input id="positionEdit" wire:model.defer="position" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                        @error('position')
                            <x-jet-input-error for="position" class="mt-2" />
                        @enderror
                    </div>
                    ...
                    <div class="block">
                        ...
                        <input id="companyEdit" wire:model.defer="company" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
                        @error('company')
                            <x-jet-input-error for="company" class="mt-2" />
                        @enderror
                    </div>
