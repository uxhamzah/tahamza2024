    ...
    <div id="formContainer" class="hidden bg-white shadow-md rounded-lg p-4">
      <form method="POST" action="{{ route('diseases.update', ['disease' => $disease->id]) }}" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="block">
            ...
            <input id="name" name="name" type="text" value="{{ $disease->name }}" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-75">
            @error('name')
